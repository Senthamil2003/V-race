...
export default function Pubqstn4() {
  ...
  return (
    ...
    <div className='qsdiv1'>
        <p className='qsp1'>4.How frequently does filler appear in your presentations?</p>
...
<input type="range" min="0" max="5" class="form-range" defaultValue={0} id="range"/>
    ...
    <Link to="/test/main/pqs5">  <button onClick={click} className='sbtn7'>Next</button></Link>
